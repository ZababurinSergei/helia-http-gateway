...
const HELIA_RELEASE_INFO_API = (version) => `https://api.github.com/repos/ipfs/helia/git/ref/tags/helia-v${version}`;
export function rpcApi(opts) {
    const log = opts.helia.logger.forComponent('rpc-api');
    let heliaVersionInfo;
    /**
     * Get the helia version
     */
    async function heliaVersion(request, reply) {
        try {
     ...
     * GC the node
     */
    async function gc(request, reply) {
    ...
    return [{
            url: '/api/v0/version',
            method: ['POST', 'GET'],
            handler: async (request, reply) => heliaVersion(request, reply)
        }, {
            url: '/api/v0/repo/gc',
            method: ['POST', 'GET'],
            handler: async (request, reply) => gc(request, reply)
        }, {
            url: '/api/v0/http-gateway-healthcheck',
            method: 'GET',
            handler: async (request, reply) => healthCheck(request, reply)
        }, {
            url: '/*',
            method: 'GET',
...
//# sourceMappingURL=helia-rpc-api.js.map